...
export function imageMapIf(
  ...
  function changeColorYesNo(img: Image, x: number, y: number): Color {
    if (cond(img, x, y)) {
...
export function mapWindow(
  ...
  function isWithinBounds(img: Image, x: number, y: number): boolean {
...
export function makeGrayish(img: Image): Image {
  ...
  function flipPixelArray(color: Color): Color {
  ...
  function checkIfNotGray(img: Image, x: number, y: number): boolean {
